...
class SequenceGenerator:
    ...
    def load_weights(self):
        ...
        # self.sp = ByteLevelBPETokenizer(self.vocab_path)
        self.sp = GPT2Tokenizer.from_pretrained(self.vocab_path)
    ...
    def sample_sequence(self,
        ...
        if context == None:
            ...
            return
        encoded_ids = self.sp.encode(context)
        print(encoded_ids)
        context = tf.expand_dims(([bos] + encoded_ids), 0)
        prev = context
        output = context
        past = None
        ...
        print(pred[1:])
        generated_seq = self.sp.decode(pred[1:])
